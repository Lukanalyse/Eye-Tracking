...
def evaluate_sequence_score0(
    ...
    score_params = Score0Params(sigma_score=float(sigma_score))
...
def main() -> None:
    ...
    if not sequences:
        raise RuntimeError("No valid sequences found for omega sensitivity analysis.")

    # Compute the sigma_score grid only once
    ...
    output_csv = RESULTS_DIR / "stage0_sigma_score_omega_sensitivity.csv"
    results_df.to_csv(output_csv, index=False)

    print("=" * 80)
    print("STAGE 0 OMEGA SENSITIVITY")
    print("=" * 80)
